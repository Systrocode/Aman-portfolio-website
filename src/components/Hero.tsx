    ...
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden pt-36">
      <div className="container mx-auto px-6 z-10 relative">
        <div className="max-w-6xl mx-auto text-center px-4">
            ...
            <span className="block">Hi, I'm Aman Gupta</span>
            <span className="block">
              <AnimatedText text="CERTIFIED ETHICAL HACKER" />
            </span>
          </h1>
          ...
          >
            <span className="block">I secure</span>
            <AnimatedText 
              text={[
                " Digital infrastructures & networks ", 
                "Applications through penetration testing", 
                "Systems with vulnerability assessments",
          ...
          >
           Protecting digital assets through ethical hacking, penetration testing, and comprehensive security assessments.
          </motion.p>
          ...
          >
            <a href="https://www.linkedin.com/in/aman-gupta-5193a6252/" target="_blank" rel="noopener noreferrer" className="group">
          ...
          >
            <a href="#features" className="gradient-border-button">
