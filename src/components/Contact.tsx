...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'amankhandelwal861205@gmail.com',
    href: 'mailto:amankhandelwal861205@gmail.com',
    bg: 'bg-blue-700',
  ...
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/aman-gupta-5193a6252',
    href: 'https://www.linkedin.com/in/aman-gupta-5193a6252/',
    bg: 'bg-blue-800',
    iconColor: 'text-white',
  },
];
...
const SecurityFacts = () => (
  <Card className="glowing-card bg-gray-900/70 border-gray-800 rounded-xl transition-all duration-300 overflow-hidden h-full flex flex-col justify-center">
    <CardHeader>
      <CardTitle className="text-3xl font-bold text-white mb-2">Security Facts</CardTitle>
      <p className="text-gray-400 text-sm">Cybersecurity insights & industry knowledge</p>
    </CardHeader>
    <CardContent>
      {/* Facts Grid */}
      <div className="grid grid-cols-1 gap-4 mb-8">
        <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-lg p-4 border border-red-500/30">
          <div className="text-lg font-bold text-red-400 mb-2">🚨 Cyber Attack Frequency</div>
          <div className="text-sm text-gray-300">A cyber attack occurs every 39 seconds globally</div>
        </div>
        <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-lg p-4 border border-blue-500/30">
          <div className="text-lg font-bold text-blue-400 mb-2">🔐 Password Security</div>
          <div className="text-sm text-gray-300">81% of data breaches are caused by weak passwords</div>
        </div>
        <div className="bg-gradient-to-br from-green-500/20 to-teal-500/20 rounded-lg p-4 border border-green-500/30">
          <div className="text-lg font-bold text-green-400 mb-2">💰 Cost of Breaches</div>
          <div className="text-sm text-gray-300">Average data breach costs $4.45 million in 2023</div>
        </div>
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-4 border border-purple-500/30">
          <div className="text-lg font-bold text-purple-400 mb-2">⚡ Detection Time</div>
          <div className="text-sm text-gray-300">It takes 277 days on average to detect a breach</div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-center">
          <div id="SocailIcons" className="relative">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/aman-gupta-5193a6252/" target="_blank" rel="noopener noreferrer" className="icons linkedin group">
  ...
  return (
    <section id="contact" className="section-container">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
        {/* Left: Security Facts, Contact Methods */}
        <SecurityFacts />
        {/* Right: Contact Form */}
        <ContactForm />
      </div>
